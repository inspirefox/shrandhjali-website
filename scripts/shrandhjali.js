...
function inputFieldChangeMine(e) {
    ...
    document.getElementById('funeral-date').innerHTML = document.getElementById('funeral-date-field').value;

    document.getElementById('funeral-datetime').innerHTML = document.getElementById('funeral-datetime-field').value;

    document.getElementById('funeral-time').innerHTML = document.getElementById('funeral-time-field').value;
